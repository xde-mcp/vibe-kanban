...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::task_attempts::CreateWorkspaceFromPrBody::decl(),
        server::routes::task_attempts::CreateWorkspaceFromPrResponse::decl(),
        server::routes::task_attempts::CreateFromPrError::decl(),
